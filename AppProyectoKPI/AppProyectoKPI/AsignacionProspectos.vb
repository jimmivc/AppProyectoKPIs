...
Public Class AsignacionProspectos
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        If (Dt Is Nothing) Then
            MsgBox("No existe ningun prospecto")
        Else
    ...
    Private Sub BtnListarAsignados_Click(sender As Object, e As EventArgs)
        ...
        Else
            configurarColumnasListadoUsuariosAsignados(CargaDataGrids.llenarGrid(DataGridView2, ProspectoBL.getListaProspecto()))
    ...
    Private Sub actualizarListaUsuariosAsignados(iduser As Integer)
        Dim response = ProspectoBL.getListaProspectoxUsuario(iduser)
        Dim dt As DataTable
        dt = New DataTable("Tabla")
    ...
    Private Sub ComboBoxEjecutivos_SelectedIndexChanged(sender As Object, e As EventArgs) Handles ComboBoxEjecutivos.SelectedIndexChanged
        Try
            actualizarListaUsuariosAsignados(ComboBoxEjecutivos.SelectedValue)
        Catch ex As Exception
