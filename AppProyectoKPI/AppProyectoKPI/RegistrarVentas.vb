...
Public Class RegistrarVentas
    ...
    Private Sub CargaBusquedaProspecto_Load(ByVal identificacion As String)
        ...
        Dim response = ProspectoBL.ObtenerProspectoXIdentificacionConUsuario(identificacion)
        ...
        Else
            ...
            If (response.Usuario Is Nothing) Then
                MsgBox("El prospecto seleccionado no tiene el usuario asignado")
            Else
